                ...
                <div class="card-header d-flex flex-wrap align-items-center gap-2">
                    ...
                    <div class="d-flex gap-2 justify-content-end text-end">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#standard-modal">Insert New</button>
                    </div>
                </div>
                ...
                response.customers.forEach(function(customer) {
                    rows += `<tr>
                        ...
                        <td class="text-center" width="150">
                            <button class="btn btn-info btn-sm waves-effect waves-light view-customer" data-id="${customer.id}">View</button>
                            <button class="btn btn-success btn-sm waves-effect waves-light edit-customer" data-id="${customer.id}">Edit</button>
                            <a href="/api/customer-delete/${customer.id}" class="btn btn-danger btn-sm waves-effect waves-light delete-customer">Delete</a>       
                        </td>
                    </tr>`;
                });
